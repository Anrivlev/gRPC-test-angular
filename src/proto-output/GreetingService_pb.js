...
proto.HelloRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.HelloRequest.repeatedFields_, null);
};
 ...
 * @const
 */
proto.HelloRequest.repeatedFields_ = [2];
...
proto.HelloRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    hobbiesList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f
  };
 ...
 * @return {!Array<string>}
 */
proto.HelloRequest.prototype.getHobbiesList = function() {
 ...
 * @return {!proto.HelloRequest} returns this
 */
proto.HelloRequest.prototype.setHobbiesList = function(value) {
 ...
 * @return {!proto.HelloRequest} returns this
 */
proto.HelloRequest.prototype.addHobbies = function(value, opt_index) {
 ...
 * @return {!proto.HelloRequest} returns this
 */
proto.HelloRequest.prototype.clearHobbiesList = function() {
